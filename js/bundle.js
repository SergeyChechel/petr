...
function calc() {
  ...
  function addActiveClass(ratio, sex) {
    if (ratio) {
      var elements = document.querySelectorAll("[data-ratio]");
    ...
    if (sex) {
      var _elements = document.querySelectorAll("#gender div");
...
function cards() {
  var Card = /*#__PURE__*/function () {
    function Card(img, name, text, price) {
      var parentSel = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : '.menu .container';
...
function forms(formSelector, modalSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (event) {
      ...
      Object(_services_services__WEBPACK_IMPORTED_MODULE_9__["postData"])('http://localhost:3000/requests', json
      /*JSON.stringify(obj)*/
      ).then(function (data) {
        console.log(data);
  ...
  function showThenksModal(message, form) {
    ...
    if (form.classList.contains('order__form')) {
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["openModal"])(modalSelector);
    }
    ...
    setTimeout(function () {
      ...
      Object(_modal__WEBPACK_IMPORTED_MODULE_8__["closeModal"])(modalSelector);
    }, 3000);
  }
}
...
function slider(_ref) {
  ...
  function showSli(event) {
    var slide = event.target.dataset.slide;
    slideIndex = slide;
    glowDot(null, event);
  ...
  function addZero(amount, index) {
    return amount < 10 ? "0".concat(index) : index;
  }
...
window.addEventListener('DOMContentLoaded', function () {
  Object(_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["tabs"])('.tabheader__item', '.tabcontent', '.tabheader__items', 'tabheader__item_active');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_2__["modal"])('[data-modal]', '.modal');
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["timer"])('.timer', '2020-11-11');
  Object(_modules_cards__WEBPACK_IMPORTED_MODULE_4__["cards"])();
  Object(_modules_calc__WEBPACK_IMPORTED_MODULE_5__["calc"])();
  Object(_modules_forms__WEBPACK_IMPORTED_MODULE_6__["forms"])('form', '.modal');
